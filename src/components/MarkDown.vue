<template>
  <div class="mdContainer" :class="{ fullPage: fullPageStatus }">
    <div class="navContainer" v-if="navStatus">
      <div class="nameContainer" v-if="icoStatusP" @click="happyDay">mdEditor</div>
      <div class="markContainer">
        <ul class="markListGroup">
          ...
          <li class="markListItem" @click="updataImg">
...
export default {
  ...
  methods: {
    ...
    updataImg: function() {
      this.$store.commit("blopen");
    },
    addImage: function(imgValue) {
      insertContent("![Vue](" + imgValue + ")", this);
    },
